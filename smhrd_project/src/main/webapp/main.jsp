...
<html style="font-size: 16px;">
  <head>
	...
	<link rel="stylesheet" href="main_page.css" media="screen">
  ...
  <body data-home-page="main_page.html" data-home-page-title="main_page" class="u-body u-xl-mode"><header class="u-clearfix u-header u-header" id="sec-fdc6"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xl u-sheet-1">
        <a href="login.html" class="u-image u-logo u-image-1" data-image-width="512" data-image-height="512">
          <img src="images/male-silhouette-variant-showing-muscles.png" class="u-logo-image u-logo-image-1">
        </a>
        <h3 class="u-headline u-text u-text-default-xs u-text-1">
          <a href="/"> 운동 헬스업<br>
          </a>
        </h3>
        <a href="login.html" class="u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-50 u-btn-1">로그인/회원가입</a>
      </div></header> 
    <section class="u-clearfix u-palette-5-light-2 u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xl u-section-1" id="sec-bf53">
      ...
      <div class="u-container-style u-group u-radius-12 u-shape-round u-white u-group-2" data-animation-name="customAnimationIn" data-animation-duration="1500">
        <div class="u-container-layout u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xl u-container-layout-2">
          ...
          <p class="u-text u-text-2" align="center">PT를 받기에는 돈이 너무 비싸죠?<br> 혼자 운동 하기에는 정보가 너무 없고<br><br> 간단한 설문을 통해 여러분이 원할만한 운동을 추천 해드릴게요</p>
        </div>
      </div>
    </section>
      ...
      <div class="u-list u-list-1">
        <div class="u-repeater u-repeater-1">
          <div class="u-align-center u-container-style u-list-item u-radius-12 u-repeater-item u-shape-round u-white u-list-item-1">
            <div class="u-container-layout u-similar-container u-valign-top-lg u-valign-top-md u-valign-top-sm u-valign-top-xl u-container-layout-1"><span class="u-align-left u-file-icon u-icon u-icon-circle u-palette-1-base u-text-white u-icon-1"><img src="images/5.png" alt=""></span>
              <h5 class="u-custom-font u-text u-text-default u-text-font u-text-1">오늘의 운동 추천</h5>
              <p class="u-text u-text-palette-5-dark-2 u-text-2">오늘 뭐 하지 내일 뭐 하지<br>이제는 고민하지 마세요.<br>저희가 하루 하루 "추천" 해드릴게요
              </p>
            </div>
          </div>
          <div class="u-align-center u-container-style u-list-item u-radius-12 u-repeater-item u-shape-round u-white u-list-item-2">
            <div class="u-container-layout u-similar-container u-valign-top-lg u-valign-top-md u-valign-top-sm u-valign-top-xl u-container-layout-2"><span class="u-align-left u-file-icon u-icon u-icon-circle u-palette-1-base u-text-white u-icon-2"><img src="images/6.png" alt=""></span>
              <h5 class="u-custom-font u-text u-text-default u-text-font u-text-3">운동 캘린더</h5>
              <p class="u-text u-text-palette-5-dark-2 u-text-4">캘린더에서 날짜만 선택하면&nbsp;<br>여러분이 그날 어떤 운동을 하였는지&nbsp;<br>알려드릴게요
              </p>
            </div>
          </div>
        </div>
